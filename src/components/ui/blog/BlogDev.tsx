        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-2">
          <div className="grid gap-5 lg:grid-cols-1 sm:max-w-sm sm:mx-auto lg:max-w-full">
            <div
              ...
              className="overflow-hidden transition-shadow duration-300 text-white rounded-xl p-4"
            >
            ...
            >
              <a aria-label="Article">
                <img
                  src="https://themegenix.net/html/bemet/assets/img/blog/blog_post02.jpg"
                  className="object-cover w-full h-80 max-sm:h-64 rounded"
                  alt=""
                />
              </a>
              <div className="py-5">
                ...
                <a className="inline-block mb-3 text-white transition-colors duration-200 hover:text-deep-purple-accent-700">
                  <p className="text-2xl font-bold leading-5">
                    Good Source of Iron And Flesh Food
                  </p>
                </a>
                <p className="mb-4 text-white">
                  Sed ut perspiciatis unde omnis iste natus error sit sed quia
                ...
                <div className="flex space-x-4">
                  <a className="flex items-start text-white transition-colors duration-200 hover:text-deep-purple-accent-700 group">
                    <div className="mr-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
            ...
            <div
              ...
              className="overflow-hidden transition-shadow duration-300 bg-white  rounded-xl p-4"
            >
              <a aria-label="Article">
                <img
                  src="https://themegenix.net/html/bemet/assets/img/blog/blog_post03.jpg"
                  className="object-cover w-full h-80 max-sm:h-64 rounded"
                  alt=""
                />
              </a>
              <div className="py-5">
                ...
                <a className="inline-block mb-3 text-white transition-colors duration-200 hover:text-deep-purple-accent-700">
                  <p className="text-2xl font-bold leading-5">
                    Chicken Sausage For Sale Humanely Raised
                  </p>
                </a>
                <p className="mb-4 text-white">
                  Sed ut perspiciatis unde omnis iste natus error sit sed quia
                ...
                <div className="flex space-x-4">
                  <a
                    aria-label="Likes"
                    className="flex items-start text-whites transition-colors duration-200 hover:text-deep-purple-accent-700 group"
                  >
                    <div className="mr-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p className="font-semibold text-white">7.4K</p>
                  </a>
                  <a className="flex items-start text-white transition-colors duration-200 hover:text-deep-purple-accent-700 group">
                    <div className="mr-2">
                      <svg
