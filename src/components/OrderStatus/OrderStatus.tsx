        ...
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
            ...
            {data?.data.map((order: any) => (
              <>
                <div key={order._id} className="w-full px-3 min-[400px]:px-6">
                            ...
                            <div className="grid grid-cols-5">
                                ...
                                <div className="flex gap-3 lg:block">
                                  ...
                                  {order?.paymentStatus == "pending" ? (
                                    <>
                                      <button
                                        onClick={() =>
                                          handleMakeStatus(order?._id)
                                        }
                                        className="lg:mt-4 font-medium text-sm leading-7  bg-red-500 px-3 py-1 rounded-full text-white"
                                      >
                                        Confirm
                                      </button>
                                    </>
                              ...
                              <div className="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3">
                                <div className="flex gap-3 lg:block">
                                  ...
                                  <Button
                                    color="danger"
                                    className="font-medium text-base whitespace-nowrap leading-7 lg:mt-3 text-white"
                                  >
                                    Delete
                                  </Button>
                                </div>
