  ...
  return (
    <section
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-6  ">
        <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 text-center  h-96  lg:rounded-bl-full ">
          <div className="absolute flex justify-center ">
            <img
              src="https://i.ibb.co/99GtLN0/product-img03.png"
              alt="Hamburg Meat"
              className="object-cover  lg:relative -top-16 -mt-16 -right-10"
            />
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 text-center  h-96   max-sm:mt-20">
          <div className="absolute flex justify-center ">
            <img
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 text-center  h-96  lg:rounded-br-full max-sm:mt-20 ">
          <div className="absolute flex justify-center ">
            <img
              src="https://i.ibb.co/LY5YDz4/features-img01.png"
              alt="Hamburg Meat"
              className=" object-cover lg:w-96 relative -top-16 -mt-14 lg:-right-4 max-sm:relative max-sm:-top-16 max-sm:-mt-1 max-sm:-right-4"
            />
          </div>
          <div className="mt-48 md:mt-40">
            <h2 className="text-xl font-bold mt-4 ">HAMBURG MEAT</h2>
